...
\cvitem{2018}{Director of Machine Learning, Invicro, Boston, MA}
...
\section{Major Academic Collaborations}
       \cvitem{2016--present} {Collaboration with Dr. Howie Rosen, UCSF Neurology, in multiple modality and longitudinal analysis.}
       \cvitem{2013--present} {Collaboration with Dr. Yvette Sheline, UPenn Center for Neuromodulation in Depression and Stress (CNDS), in multiple modality and longitudinal analysis.}
      \cvitem{2006--present} {Collaboration with Dr. Martha Farah (UPenn) and Dr. Hallam Hurt (CHOP), understanding the effects of stress and poverty on brain development.}
      \cvitem{2006--present} {Collaboration with Dr. Murray Grossman (UPenn),  multiple modality biomarkers for frontotemporal lobar degeneration and related disorders.}
...
\item \textit{Amyloid-$\beta$ positive subjects exhibit network-specific longitudinal reductions in spontaneous brain activity}, first author, (under revision)
