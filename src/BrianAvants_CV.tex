...
\title{Brain mapping: theory \& methods}
% \address{300 Binney St, 95X55}{Cambridge, MA 02142}
\email{avants at grasp.cis.upenn.edu}
\homepage{stnava.github.io}{homepage} % The first argument is the url for the clickable link, the second argument is the url displayed in the template - this allows special characters to be displayed such as the tilde in this example
\extrainfo{My H-index: \href{http://scholar.google.com/citations?hl=en\&user=t4kkowgAAAAJ}{51
...
\cvitem{2018--present}{Visiting Associate Professor of Radiology and Medical Imaging, University of Virginia, Charlottesville, VA}

\cvitem{2018--present}{Founder and Director, Cingulate, LLC, Hampton, NH}

\cvitem{2018--present}{Senior Director of Machine Learning, Invicro, Boston, MA}

\section{Research Interests}

\cvitem{}{\textbf{Deep learning:} high-dimensional multi-output regression,
segmentation, super resolution, longitudinal embedding, multiple modality prediction,
generative adversarial networks, evaluation and interpretation of networks.}

\cvitem{}{\textbf{Brain mapping:} brain structure, function,
cognition and its interaction with environment and disease; visualization,
modality integration, reproducibility, machine learning, longitudinal analysis,
...
\cvitem{2020, Spring}{Visiting scientist at Brown University’s Institute for Computational and Experimental Research in Mathematics (ICERM) for the semester program “Model and dimension reduction in uncertain and dynamic systems”.}
\cvitem{2016--2018}{Associate Director, Imaging Analytics, Biomarkers Group, Biogen}
\cvitem{2012--2016}{Assistant Professor of Radiology, University of Pennsylvania}
\cvitem{2008--2012}{Research Associate, Radiology, University of Pennsylvania}
\cvitem{2006--2008}{Research Fellow, Radiology, University of Pennsylvania}
...
\section{Awards and Honors}
        \cvitem{2014}{Best paper award with Nicholas Tustison at STACOM 2014 challenge.}
	      ...
	      \cvitem{2013}{Advanced Normalization Tools
                ...
                finishes first in segmentation categories
...
\cvitem{2017}{Topic Editor - Neuroimage special issue on Brain Parcellation}
\cvitem{2015}{Topic Editor - Frontiers in
	      ...
	      \cvitem{current}{Ad hoc Reviewer - Nature Neuroscience}
...
\cvitem{2019}{Contributor to brain injury biomarker strategy panel sponsored by Cohen Veteran's Biosciences.}
...
\section{Major Academic Collaborations}
       \cvitem{2016--2017} {Collaboration with Dr. Howie Rosen, UCSF Neurology, in multiple modality and longitudinal analysis.}
       \cvitem{2013--2017} {Collaboration with Dr. Yvette Sheline, UPenn Center for Neuromodulation in Depression and Stress (CNDS), in multiple modality and longitudinal analysis.}
      \cvitem{2006--2018} {Collaboration with Dr. Martha Farah (UPenn) and Dr. Hallam Hurt (CHOP), understanding the effects of stress and poverty on brain development.}
      \cvitem{2006--2018} {Collaboration with Dr. Murray Grossman (UPenn),  multiple modality biomarkers for frontotemporal lobar degeneration and related disorders.}
      \cvitem{2013--2016} {Collaboration with Dr. Ruben Gur (UPenn), Brain-Behavior Laboratory (BBL), in big data analysis of normal adolescent development and early signs of neuropsychiatric disorders.}
      \cvitem{2013--2016} {Collaboration with Dr. Lyle Ungar (UPenn), analyzing the eigenspaces relating words, sentences and brain activity.}

\section{Major Academic Teaching Responsibilities}
        \cvitem{Summer 2017}{Summer advisor to Nicholas Cullen (B.S. in computer science)
          for Biogen Biomarkers internship on deep learning and multivariate analysis in
          neuroimaging of Alzheimer's Disease}
        \cvitem{2014--2016}{Faculty technical advisor, with clinical advisor Branch Coslett,
          to Dorian Pustina, postdoctoral scientist studying machine learning applied to stroke;
          \textit{Dr. Pustina is currently Director of Experimental Neuroimaging at the CHDI foundation
          for Huntington's disease research.}}
        \cvitem{2012--2017}{Ph.D. Co-Advisor of Stathis Gennatas, UPenn Doctoral
                    student, Neuroscience; \textit{currently data scientist at UCSF working with Lyle Ungar.}}
	      \cvitem{2010--2015}{Ph.D. Advisor of Ben Kandel, UPenn Doctoral
                student, Bioengineering;  Ben's work was awarded an
                oral presentation at IPMI-2013; \textit{currently a data scientist at Picwell.}}
	      \cvitem{2010--2015}{Ph.D. Co-Advisor of Paramveer Dhillon, Doctoral student,
            UPenn Computer Science with Professor Lyle Ungar;  Paramveer's
            work was an awarded an oral presentation at PRNI-2013; \textit{currently MIT post-doc studying large-scale networks.}}
        \cvitem{2012--2013}{Organizer of Provost-sponsored UPenn
     ...
     %	     \cvitem{2012}{Hosted David Van Essen for talk on Human Connectome Project}

            \section{Media Coverage}
                   \cvitem{2016}{Performed confirmatory amyloid PET analysis in the PRIME dataset and created Figure 1 and cover image associated with \href{http://www.nature.com/nature/journal/v537/n7618/full/nature19323.html}{this Nature publication.}}
                   \cvitem{2013}{CNN \href{http://www.cnn.com/2013/06/13/health/martha-farah-brain/index.html}{
                              article}  on collaboration with Martha Farah.}
            	      \cvitem{2012}{Daily
            ...
            \section{Professional Skills \& Primary Software Contributions}
                  \cvitem{Programming Languages}{Software Engineering \&
                          Programming - C++, CMake, R, Julia, Python, Bash, Rst, LaTeX, Git,
                          Gerrit, others as needed}
                  \cvitem{ANTs\\since 2008}{Advanced Normalization Tools: C++ software used broadly in
                  both academia \& industry for medical image analytics; \textbf{lead developer/designer.}}
                  \cvitem{ANTsR\\since 2012}{R statistical programming language extension of ANTs with
                  novel imaging-specific extensions; ideal for teaching; \textbf{lead developer/designer.}}
                  \cvitem{ANTsPy\\ 2017}{Python statistical programming language extension of ANTs with
                  novel imaging-specific extensions; ideal for teaching; \textit{*new* with Nicholas Cullen.}}
                  \cvitem{Neuro\\conductor\\since 2016}{The neuroconductor platform provides new data science support that
                    bridges novel medical imaging methods with the world's leading statistical platform; \textit{founder and contributor.}}
                  \cvitem{ITK\\since 2002}{The Insight ToolKit - \textbf{lead designer} for registration framework for
                  this seminal medical imaging analysis library.}
            %	      \cvitem{Visualization}{Visualization: e.g. \href{http://vimeo.com/66781467}{a gource of ANTs development}}
            ...
            \section{Languages}
                \cvitem{English}{Mothertongue}
                \cvitem{Spanish}{Intermediate/Conversational}

%            \cvitemwithcomment{English}{Mothertongue}{}
%            \cvitemwithcomment{Spanish}{Intermediate}{Conversational}

\section{Brain mapping \& data science tutorials}
\cvitem{May 2019}{"Introduction to the ANTsX Ecosystem", tutorial, ICERM, Brown University, Providence, RI.}
\cvitem{Jun 2018}{"ANTsX for decoding and resting state fMRI studies", talk and tutorial, Dartmouth College, Hanover, NH \textit{at Haxby Lab.}}
\cvitem{Aug 2017}{"ANTs and ANTsR for clinical applications", two day tutorial, Seattle Children's/University of Washington, Seattle, WA, Aug 2017, \textit{organized by Murat Maga.}}
\cvitem{Aug 2016}{"ANTs and ANTsR in biostatistics", two day tutorial at MD Anderson, Houston, TX, Aug 2016, \textit{organized by Hongtu Zhu.}}
\cvitem{Jul 2016}{Park City Mathematics Institute, Data science domain expert invitee, Park City, Utah, \textit{organized by Rafe Mazzeo, Stanford University.}}
\cvitem{Jul 2015}{"ANTs and ANTsR", one day tutorial at USC Center for Imaging Genetics, Los Angeles, June 2015, \textit{organized by Neda Jahanshad.}}
\cvitem{May 2015}{"ANTs and ANTsR in machine learning", two day tutorial with Nick Tustison, McGill University and Montreal Neurological Institute, Montreal, CN, \textit{organized by Tal Arbel.}}
\cvitem{Sep 2013}{"Multivariate Medical Imaging Analysis with R", MICCAI 2013, Nagoya, Japan.}
\cvitem{Jul 2013}{"ANTs \& Eigenanatomy", Neuroimaging Training Program, UCLA, Los Angeles, CA.}
\cvitem{Sep 2011}{"ITKv4 Image Registration Tutorial", MICCAI 2011, Toronto, Canada.}
\cvitem{Oct 2006}{"Tutorial on Neuromorphometry", MICCAI 2006, Copenhagen, Denmark.}


\section{Lectures by Invitation}
\cvitem{Jun 2017}{Invited lecture on translational brain mapping in neurodegenerative disease, Yale University, New Haven CT}
\cvitem{Mar 2017}{Lecture of multiple modality analysis of Alzheimer's disease, Duke University, Durham, NC}
\cvitem{Apr 2017}{Platform presentation at ADPD 2017, Vienna, Austria}
\cvitem{Jun 2015}{"Large-scale, predictive analytics for M$^3$ pediatric neuroimaging", International Society for Magnetic Resonance in Medicine Meeting, Toronto, CN}
\cvitem{May 2015}{Invited to deliver ANTs introduction talk at University of California, San Diego.  San Diego, CA}
\cvitem{Nov 2014}{"Functional Imaging Analysis with R", University of South Carolina}
\cvitem{Aug 2014}{"Big Image Registration", Frontiers in Human Brain Mapping Workshop, Princeton University}
\cvitem{Apr 2014}{"Eigenwords \& Eigenanatomy for Decoding Neural Representations of Semantics", HRL, Malibu, CA}
\cvitem{Feb 2014}{"ANTs \& Eigenanatomy for Integrative Brain Mapping ", University of Calgary, Calgary, Alberta}
\cvitem{Mar 2013}{"Multi-Modality Analysis", CMROI Workshop, University of Pennsylvania, Philadelphia, PA}
\cvitem{May 2012}{"Early Home Environment Impacts Cortical Thickness in Young Adulthood", Chinese Academy of Sciences, Beijing, China}
\cvitem{Oct 2012}{"A Unified Image Registration Framework for ITKv4", National Library of Medicine, Bethesda, MD}
\cvitem{Jul 2012}{"A Unified Registration Framework for ITKv4," WBIR 2012, Nashville, TN}
\cvitem{Oct 2012}{"Early Home Environment Impacts Cortical Thickness in Young Adulthood," Society for Neuroscience Press Conference, New Orleans, LA}
\cvitem{May 2012}{"Multivariate Methods for Integrating Multiple Modalities in Brain Mapping", Incheon National University, Incheon, South Korea}
\cvitem{Jun 2012}{"Eigenanatomy Methods for Multivariate Brain Mapping", University of California, San Francisco}
\cvitem{Jan 2011}{"Open Source Neonatal Brain Mapping," Washington University at St. Louis, St. Louis, MO}
\cvitem{Nov 2011}{"Multivariate analyses improve detection power for cortical longitudinal change in dementia", Society for Neuroscience Meeting, Washington D.C.}
\cvitem{Dec 2011}{"Modern analytics for neuroimaging," University of California, Los Angeles}
\cvitem{Feb 2011}{"Multivariate methods in neuroimaging", Washington Univ. at St. Louis}
\cvitem{Sep 2010}{"Open Source in Medical Imaging" Inst. of Automation, Chinese Academy of Sciences, Beijing, China}
\cvitem{Jun 2010}{``Open Source Image Registration'', National Library of Medicine, Bethesda, MD}
\cvitem{Sep 2010}{"Multivariate Longitudinal Correlation of Atrophy in White Matter and Gray Matter" MICCAI, Beijing, China}
\cvitem{Jul 2010}{"Advanced ITK-Based Image Registration,'' NLM, Bethesda, MD}
\cvitem{Sep 2010}{``Sparse Unbiased Analysis of Anatomical Variance in Longitudinal Neuroimaging,'' MICCAI 2010, Beijing China. (45 of 786 submissions accepted for oral presentation)}
\cvitem{Jun 2009}{``Grammatical comprehension and longitudinal adolescent brain development: a multivariate DTI and T1 analysis,'' Human Brain Mapping 2009, San Francisco, CA}
\cvitem{Jul 2009}{``Democratizing Hippocampus Labeling,'' Columbia University, NY, NY}
\cvitem{Jul 2009}{``Multivariate Analysis of the Adolescent Brain and its Association with Language Development,'' Columbia University, NY, NY}
\cvitem{Mar 2009}{``Follow-Up on Effects of Prenatal Cocaine Exposure on the Young Adult Brain,'' Eastern SPR, Philadelphia, PA}
\cvitem{Jul 2009}{``Multivariate Methods and Applications for Neuroimaging,'' SRI, Menlo Park, CA}
\cvitem{Jun 2008}{``The Longitudinal Effect of Neurodegeneration of Language Network Neuroanatomy and Cognition,'' Pendergrass Symposium, Univ. of Penn. Philadelphia, PA}
\cvitem{Sep 2008}{``Template-based Brain Mapping with Diffeomorphisms,'' Janelia Farm, Ashburn, Virginia}
\cvitem{Oct 2008}{``Multivariate Template-based Retinotopic Mapping,'' Stanford Vision Science Group, Stanford University, Palo Alto, CA}
\cvitem{Apr 2007}{``Symmetric Shape Averaging in the Diffeomorphic Space", International Symposium Biomedical Imaging, Washington DC}
\cvitem{Oct 2007}{``Spatiotemporal Normalization for Longitudinal Analysis of Gray Matter Atrophy in Frontotemporal Dementia,'' MICCAI 2007, Brisbane, Australia}
\cvitem{Apr 2006}{``Geodesic shape averaging,'' IEEE International Symposium on Biomedical Imaging 2006, Alexandria, VA}
\cvitem{Nov 2007}{``Mapping Statistical Patterns in Medical Images via Diffeomorphisms,'' Univ. of Pennsylvania, CIS 520 lecture, Philadelphia, PA}
\cvitem{Jul 2005}{``Shape Optimizing Diffeomorphisms in Medical Imaging,'' ISI, Utrecht, NL}
...
% \subsection{Past}
\cvitem{10/2014-9/2019}{The Imaging Genomics of Pediatric Executive Function, NIH,
  K01ES025432-01, (Avants, Brian, PI), \$275,000/annual direct
  costs, 80\% effort (Big data to knowledge (BD2K) research grant.)}

\cvitem{08/01/15-05/31/18}{Multimodal brain maturation indices modulating psychopathology and neurocognition, NIH, R01MH107235-01, (Avants, Brian, collaborator, Gur, Ruben, PI), \$275,000/annual direct costs, 5\% effort (via cost sharing with K01.)}

\cvitem{9/2013-8/2018}{Neuroscience Neuroimaging Center, NIH, P30-NS045839-07, (Detre, John, M.D., PI), \$499,727/annual direct costs, 10\% effort (Role in grant: Collaborator, To provide support for technical aspects of neuroimaging using MRI.)}

\cvitem{2014}{IARPA-sponsored Knowledge Representation in Neural Systems
  (KRNS), IARPA-BAA-12-05, 50\% effort (Role in grant: Image
  Analysis Lead)}

\cvitem{9/2012-7/2013}{Age, Hearing Loss, And Sentence Comprehension: Neural Correlates, National Institute On Aging/Nih/Dhhs, 5-R01-AG-038490-05, (Murray Grossman, PI), \$291,978/annual direct costs (Role in grant: Co-PI)}

\cvitem{9/2011-8/2015}{Continued Development and Maintenance of ITK-SNAP 3D Image Segmentation Software, NIH, R01-EB014346-01, (Yushkevich, Paul A., Ph.D., PI), \$350,824/annual direct costs (Role in grant: Collaborator)}

\cvitem{9/2010-8/2015}{TDP-43 Proteinopathies in ALS-Dementia, NIH, P01-AG032953-02, (Lee, Virginia/Grossman, Murray, PI), \$729,272/annual direct costs (Role in grant: Collaborator)}

\cvitem{6/2010-6/2013}{Fundamental Refactoring Of Deformable Image Registration In Itk With Distributed Computing And Gpu Acceleration, National Library Of Medicine, HHSN276201000492P, (JAMES C GEE, PI), \$472,861/annual direct costs (Role in grant: Co-PI)}

\cvitem{8/2007-4/2013}{In Utero Cocaine Exposure: Adolescent \& Young Adult Neurocognitive Outcome, Children's Hospital of Philadelphia, R01-DA14129-08, (Gee, James C., Ph.D., PI), \$102,515/annual direct costs (Role in grant: Collaborator, To explore the effects of gestational cocaine exposure on neurocognitive outcome of adolescents and young adults)}

\cvitem{2/2011-1/2012}{Longitudinal Multi-model Neuroimaging of Natural Recovery after Traumatic Brain Injury: A Pilot Study, Moss Rehab Research Institute/NIH, (\textbf{Avants}, Brian Ph.D., PI), \$7,764/annual direct costs (Role in grant: PI)}


\cvitem{6/2010-5/2012}{Parkinsons Disease \& Dementia, NIH, P50-NS053488-04S1, (Trojanowski/Grossman, PI), \$132,641/annual direct costs (Role in grant: Collaborator)}


\cvitem{9/2009-5/2010}{Pediatric Template Of Brain Perfusion, National Institute Of Mental Health/Nih/Dhhs, 3-R01-MH-080892-01A2S1, (JiongJiong Wang, PI) \$0/annual direct costs, (Role in grant: Co-PI)}

\cvitem{9/2009-8/2012}{Tract-Specific Analysis of Brain White Matter, NIH, R01-NS065347-02, (Gee, James C., Ph.D., PI), \$370,667/annual direct costs, (Role in grant: Collaborator)}


\cvitem{9/2008-9/2011}{Advanced Neuroimages Registration Methods: Effects of Prenatal Cocaine Exposure, NIH, (James C. Gee, PI: Brian \textbf{Avants}, Co-Investigator), \$354,375/annual direct costs, (Role in grant: Co-PI)}


\cvitem{6/2008-1/2011}{The Longitudinal Effect of Neurodegeneration onLanguage-Network Neuroanatomy and Cognition, University of Pennsylvania, Institute of Aging, (James C. Gee, PI: Brian \textbf{Avants}, Co-Investigator), (Role in grant: Co-PI)}


\cvitem{4/2007-1/2011}{Long Term Effects of Prenatal Cocaine Exposure, NIH, (Hallam Hurt, PI), (Role in grant: Research Scientist)}


\cvitem{4/2006-3/2010}{Shape Optimizing Diffeomorphisms for Computational Biology, NIH - UCLA Center for Computational Biology, R01-EB006266, (James C. Gee, PI) (Role in grant: Research Scientist)}


\cvitem{8/2004-6/2009}{Surface-based Cortical Analysis in ITK: Segmentation,
  Conformal Flattening and Statistics, NLM-NIH ITK Development Grant,
 (James C. Gee, PI, Role in grant: Co-PI, Open source development)}


\cvitem{9/2002-6/2010}{Bioengineering Training in Cardiovascular Pathophysiology,
  Institute for Medicine and Engineering Training Grant, University of Pennsylvania, Philadelphia, PA, (Peter Davies, PI), (Role in grant: Trainee )}


\section{Articles Under Review/Development}

\begin{enumerate}
\item \textbf{Avants}, B. B.; Tustison, N. J.; Stone, J. R. (2018), \textit{Software for learning multi-view brain embeddings and application to imaging genetics of depression}, Frontiers in Neuroinformatics (submitted)
\item \textit{A reproducible analysis pipeline for population studies of ASL-based cerebral blood flow}, last author, (in process)
\item \textit{Environmental influences on early childhood hippocampal growth}, with Martha Farah and Hallam Hurt, (in process)
\item \textit{Joint Fusion for optimal template creation}, with Nicholas J Tustison, (in process)
\item \textit{The ANTs longitudinal cortical thickness pipeline}, with Nicholas J Tustison, (submitted)
\end{enumerate}
